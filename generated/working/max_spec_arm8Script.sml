...
Definition arm8_max_pre_def:
 arm8_max_pre (pre_x0:word64) (pre_x1:word64) (s:arm8_state) : bool =
  ((pre_x1 = (s.REG 1w)) /\ (pre_x0 = (s.REG 0w)))
End

Definition arm8_max_post_def:
 arm8_max_post (pre_x0:word64) (pre_x1:word64) (ms:arm8_state) : bool =
  (((((ms.REG 0w) = pre_x0) \/ ((ms.REG 0w) = pre_x1)) /\ (pre_x0 <=+ (ms.REG 0w))) /\ (pre_x1 <=+ (ms.REG 0w)))
End
